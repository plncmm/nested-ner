...
class BiLSTM(nn.Module):
  def __init__(self, vocab_size, n_tags, embedding_dim, lstm_dim, embedding_dropout, lstm_dropout, output_layer_dropout, lstm_layers, embedding_weights, use_bilstm = True):
  ...
  def init_embeddings(self, embedding_dim, pretrained=None, freeze=False):
